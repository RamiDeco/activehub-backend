...
@WebMvcTest(controllers = EliminarReseniaController.class)
@AutoConfigureMockMvc(addFilters = false)
@Import(GlobalExceptionHandler.class)
class EliminarReseniaControllerTest {

    @Autowired
    private MockMvcTester mvc;

    @MockitoBean
    private EliminarReseniaService eliminarReseniaService;
    ...
    void eliminar_devuelve204() {
        ...
        assertThat(mvc.delete().uri("/api/alumno/resenas/{id}", id)
